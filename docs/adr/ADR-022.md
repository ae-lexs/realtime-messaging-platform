...
**Internal:** [ADR-021](ADR-021.md) (substrate; acceptance conditions discharged) · [ADR-011](ADR-011.md) (topics, partitioning, DLQ — wire format amended here) · [ADR-003](ADR-003.md) (history invariant scoped here) · [ADR-013](ADR-013.md) (content scope honoured by D3) · ADR-007 amendment (two-store schema — the `outbox` table lands there)
