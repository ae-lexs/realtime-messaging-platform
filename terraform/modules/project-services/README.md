...
| services | Google Cloud APIs to enable for the platform. | `list(string)` | <pre>[<br/>  "compute.googleapis.com",<br/>  "container.googleapis.com",<br/>  "artifactregistry.googleapis.com",<br/>  "cloudresourcemanager.googleapis.com",<br/>  "billingbudgets.googleapis.com",<br/>  "iam.googleapis.com",<br/>  "logging.googleapis.com",<br/>  "monitoring.googleapis.com"<br/>]</pre> | no |
