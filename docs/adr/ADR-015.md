...
> [!IMPORTANT]
> **Amended for the GCP substrate (2026-07-26, M1.2 — see the Changelog).** The auth *logic* below is unchanged and was carried over intact; ADR-021 judged it 13/20 substrate-neutral and the re-home confirmed that. What changed is where state and secrets live. Read the body with these four substitutions in mind:
>
...
- **Status**: Proposed (amended 2026-07-26 for GCP)
- **Date**: 2026-02-01
